...
DEPENDENCIES=['click>=8.1', 'importlib-metadata', 'pathlib', 'snakemake', 'datetime']
...
def get_version():
    main_file=os.path.join(CURDIR, "src", "pywrapper", "__init__.py")
...
setup(
    name="pywrapper",
    author="Yourong Bao",
    author_email="maggiemaizibao@gmail.com",
    python_requires=">=3.8",
    description="All my python wrappers",
